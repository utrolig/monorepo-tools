...
var copy_template_1 = require("./copy-template");
...
var startInquirer = function () {
    return inquirer_1.default
        ...
        validate: function (input) {
            ...
            if (paths_1.appAlreadyExists(input)) {
                return "An application with name " + chalk_1.default.red(lodash_kebabcase_1.default(input)) + " already exists. Please choose another one.";
            }
            return true;
        }
    })
